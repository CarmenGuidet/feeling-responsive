	...
	<div class="row">
		<div class="small-12 columns centered-content">
			<a id="logo" href="http://localhost:4000/feeling-responsive/" title="Feeling Responsive – A Flexible Theme for Jekyll">
				<img src="http://localhost:4000/feeling-responsive/assets/img/Logos.png" alt="Feeling Responsive – A Flexible Theme for Jekyll" style="max-width: 600px; height: auto; display: block; margin: 10px auto;">
			</a>
